...
export default function FormLogin({
    ...
    return (
        <div className="sm:rounded-md sm:border sm:border-input px-12 py-10 w-screen sm:w-96">
            <h2 className="text-2xl font-semibold leading-none tracking-tight mb-3">Login</h2>
            <Form {...form}>
                {
                    isVerifield && (
                        <p className="text-center text-green-500 mb-3 text-sm">
                ...
                <div className="mt-4 gap-4 flex flex-col">
                    <ButtonSocial
                        className="bg-[#24292f] hover:bg-[#31383f]"
                        provider="github"
                    >
                        <svg
